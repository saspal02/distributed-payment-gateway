package com.saswat.paygrid.operations_service.webhook;

import com.saswat.paygrid.common_lib.enums.WebhookEventStatus;
import com.saswat.paygrid.operations_service.entity.DlqEvent;
import com.saswat.paygrid.operations_service.entity.WebhookEvent;
import com.saswat.paygrid.operations_service.repository.DlqEventRepository;
import com.saswat.paygrid.operations_service.repository.WebhookEventRepository;
...
public class WebhookDlqRecorder {
    ...
    public void recordConsumerFailed(ConsumerRecord<String, Map<String, Object>> record, String error) {
        ...
        try {
            ...
            log.error("Error while processing the record, offset: {}", record.offset());
        }
